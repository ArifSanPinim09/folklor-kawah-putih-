    ...
    <footer className="bg-arang-900 text-kabut-50">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          {/* WhatsApp Contact */}
          <a
            href="https://wa.me/6281234567890?text=Halo%2C%20saya%20tertarik%20dengan%20wisata%20Kawah%20Putih"
            target="_blank"
            rel="noopener noreferrer"
            className="mt-6 inline-flex items-center gap-2 rounded-full bg-green-600 px-6 py-3 text-white transition-colors hover:bg-green-700"
          >
